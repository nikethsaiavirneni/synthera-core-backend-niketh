...
class SecretsManagerHandler:
    def __init__(self, config_file='synthera_core_backend_api/com/dimcon/synthera/resources/config.ini'):
...
if __name__ == "__main__":
    try:
        ...
        secret_data = SecretsManagerHandler.get_secrets(config_file=config_path)
