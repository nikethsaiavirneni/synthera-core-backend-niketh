...
from com.dimcon.synthera.resources.organization_and_employees.employees import Employee  # Import Employee model
...
class LeadStage(Base):
    ...
    created_by = Column(Integer, ForeignKey(Employee.emp_id), nullable=False)  # Updated FK
    updated_by = Column(Integer, ForeignKey(Employee.emp_id))                  # Updated FK
