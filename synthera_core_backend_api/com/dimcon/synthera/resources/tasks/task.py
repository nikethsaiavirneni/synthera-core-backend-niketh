...
class Task(Base):
    ...
    timezone = Column(String(100), default='UTC')  # Task timezone
    recurrence_rule = Column(Text, nullable=True)  # RRULE for recurring tasks
...
if __name__ == "__main__":
    ...
    logger.info("Tasks script completed.")
